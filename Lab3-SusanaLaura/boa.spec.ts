...
//span[@class='ui-datepicker-month'][text()="Abril"]//ancestor::div[contains(@class,"ui-datepicker-group ui-datepicker-group")]//a[@class='ui-state-default'][text()="2"]
...
test.skip('Playwright TextField', async ({ page }) => {
